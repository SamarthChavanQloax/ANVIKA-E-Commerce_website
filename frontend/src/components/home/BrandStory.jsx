...
const BrandStory = () => {
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-12 max-w-[90rem] mx-auto bg-background">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="flex flex-col justify-center order-2 lg:order-1">
          <RevealOnScroll direction="right">
            ...
            <h2 className="text-4xl md:text-5xl font-serif leading-[1.2] mb-8 text-text font-light">
              Born from a love for Indian craftsmanship.
            </h2>
            <div className="space-y-6 text-text-muted font-light text-base leading-relaxed tracking-wide mb-10">
              <p>
